...
const Contact = () => {
  ...
  const boutiques = [
    { city: 'MUMBAI', location: 'Wayne Tower, Level 42', phone: '+91 1800 202 2026', email: 'mumbai@wayne.com', hours: '10:00 - 20:00', lat: 18.9221, lng: 72.8341 },
    { city: 'LONDON', location: '17-19 New Bond Street', phone: '+44 20 7493 2714', email: 'london@wayne.com', hours: '10:00 - 18:30', lat: 51.5235, lng: -0.1444 },
    { city: 'DUBAI', location: 'The Dubai Mall, Fashion Avenue', phone: '+971 4 339 8000', email: 'dubai@wayne.com', hours: '10:00 - 23:00', lat: 25.1972, lng: 55.2744 },
    { city: 'PARIS', location: '12 Place Vendôme', phone: '+33 1 55 04 60 00', email: 'paris@wayne.com', hours: '11:00 - 19:00', lat: 48.8675, lng: 2.3292 }
  ];
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-wrap items-center justify-between gap-12 pt-16 border-t border-wayne-border/50">
          <div className="space-y-2">
            <p className="text-[9px] font-black uppercase tracking-[0.4em] text-white">Wayne Enterprises Global Network</p>
            <p className="text-[8px] font-bold uppercase tracking-[0.3em] text-wayne-text-muted">Managed by Gotham Operations Division</p>
          </div>
          <div className="flex gap-12">
            {[
              { name: 'Instagram', label: 'IMG' },
              { name: 'LinkedIn', label: 'LNK' },
              { name: 'Twitter', label: 'TWT' },
              { name: 'Archives', label: 'ARC' }
            ].map(social => (
              <a key={social.name} href="#" className="flex items-center gap-2 group">
